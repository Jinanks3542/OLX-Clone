    ...
    <div>
      <nav className='fixed z-50 w-full overflow-auto p-2 pl-3 pr-3 shadow-md bg-slate-100 border-solid border-b-white'>
        ...
        <div className='ml-5 mr-2 relative w-full main-search'>
            <input placeholder='Find cars,phones,and More...' 
            className='w-full p-3 boreder-black border-solid border-2 rounded-md placeholder:text-ellipsis focus:outline-none focus:border-teal-300'
            type="text" name='' id=''
            />
