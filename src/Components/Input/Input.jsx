...
const Input = (props) => {
  ...
  return (
    <div className='pt-2 w-full relative'>
      <input onChange={(event)=>setInput(event.target.value)} type="text"  name='' id='title' className='w-full border-2 border-black rounded-md p-3 pt-4 pb-2 focus:outline-none peer ' required />
